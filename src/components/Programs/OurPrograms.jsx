      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-lg mb-4">
            ...
            promoting robust, enforceable laws and accountability mechanisms
            that safeguard endangered marine species and ensure justice within
            the Blue Economy.
          </p>
        ...
        <div className="bg-blue-100 rounded-2xl shadow-md p-8 border-l-4 border-blue-600">
          ...
          <ul className="list-disc list-inside space-y-2 mb-4">
            <li>
              Disrupt organized shark fin trafficking in Kenya and the WIO.
            </li>
            <li>
              Document environmental and economic crimes tied to illegal
              exports.
            </li>
            <li>Prosecute high-profile traffickers.</li>
            <li>
              Build pressure for governance reform and international
              cooperation.
            </li>
          </ul>
          <h3 className="text-xl font-semibold mb-2 text-blue-700">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-base leading-relaxed">
            <strong>Why It Matters:</strong> Many coastal communities are
            excluded from marine governance. Misconceptions about sharks,
            economic pressures, and lack of access to knowledge often lead to
            unsustainable practices. This program bridges the gap between
            awareness and action through campaigns, schools, and local
            partnerships.
          </p>
        </div>
      </div>
