  ...
  return (
    <section className="bg-blue-50 text-blue-900 py-16 px-6 md:px-16">
      <div className=" mx-auto">
        ...
        <p className="text-lg md:text-xl text-justify  mx-auto mb-12">
          <strong>WAVES </strong>
          ...
          united by a shared vision: oceans where marine wildlife thrives, laws
          are enforced, and communities are at the heart of conservation.
        </p>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6 md:p-10 mb-12">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            Through legal advocacy, science, strategic litigation, and
            grassroots action, WAVES aims to dismantle the networks that
            threaten marine biodiversity and to ensure a sustainable future for
            our oceans.
          </p>
        </div>
        ...
        <div className="bg-blue-100 border-l-4 border-blue-600 rounded-2xl p-6 md:p-10">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            />
            <p className="text-base md:text-lg leading-relaxed">
              Each year, over <strong>97 million sharks</strong> are
              slaughtered, many for the cruel and unsustainable shark fin trade,
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <p className="text-base md:text-lg leading-relaxed">
              In Kenya, over{" "}
              <strong>80% of native shark and ray species</strong> face
              extinction threats due to illegal fishing, unregulated bycatch,
