    ...
    <section className="bg-blue-50 text-blue-900 py-16 px-6 md:px-16">
      ...
      <div className="bg-blue-100 border-l-4 border-blue-600 rounded-2xl p-6 md:p-10">
        ...
        <p className="text-base md:text-lg leading-relaxed mb-4">
          Since the 1970s, shark and ray populations have plummeted by more than
          71%, with iconic species like hammerheads, blacktips, and reef sharks
        ...
        <p className="text-base md:text-lg leading-relaxed">
          WAVES was formed to reverse this. We aim to end illegal shark finning,
          stop trafficking of endangered species, and ensure Kenya’s marine
          ecosystems are governed by{" "}
          <strong>justice, science, and community action</strong>.
        </p>

        <p className="text-base md:text-lg leading-relaxed mt-4">
          We unite{" "}
          <strong>lawyers, scientists, advocates, and local communities</strong>{" "}
          in a rights-based, evidence-driven mission to restore ocean integrity
