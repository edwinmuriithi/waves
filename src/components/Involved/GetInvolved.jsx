...
function GetInvolved() {
  const data = [
    {
      image:
        "https://plus.unsplash.com/premium_photo-1679689588082-33cef290be4d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8YmVhY2glMjBjbGVhbmluZ3xlbnwwfHwwfHx8MA%3D%3D",
    ...
    {
      image:
        "https://plus.unsplash.com/premium_photo-1661827154548-827bb8bc5de8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8YmVjb21lJTIwYSUyMHBhcnRuZXIlMjBtYXJpbmUlMjBsaWZlfGVufDB8fDB8fHww",
    ...
    {
      image:
        "https://plus.unsplash.com/premium_photo-1684358604857-407f08e0458d?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    <section className="bg-blue-50 text-blue-900 py-20">
      ...
      <div className="text-center mb-16 max-w-3xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-blue-700 font-sans">
          Discover how you can support Wildlife Advocates for Vital Ecosystems
          and Species (WAVES) in our fight for ocean justice and marine
